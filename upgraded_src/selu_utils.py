...
def convolution_selu(x, filter, padding='SAME', strides=None, dilation_rate=None):
    ...
    """
    w = tf.compat.v1.get_variable(name='weights', initializer=xavier_initializer_convolution(shape=filter, dist='normal'))
